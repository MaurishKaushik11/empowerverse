#!/usr/bin/env python3
"""
Sample Data Generator for EmpowerVerse (SQLite Version)
Creates realistic sample data for presentation and demo purposes using SQLite
"""
...
from app.database.models import (
    ...
    UserEmbedding, PostEmbedding, RecommendationLog, Base
)
from datetime import datetime, timedelta
import random
import json

# Create SQLite engine for demo
SQLITE_DATABASE_URL = "sqlite:///./empowerverse_demo.db"
    ...
    posts_data = [
        {
            ...
            "rating_count": 234,
            "average_rating": 4.7,
            "tags": json.dumps(["AI", "Machine Learning", "Programming", "Future Tech"])
        },
        {
            ...
            "rating_count": 445,
            "average_rating": 4.8,
            "tags": json.dumps(["Startup", "Entrepreneurship", "Business", "Success Story"])
        },
        {
            ...
            "rating_count": 189,
            "average_rating": 4.6,
            "tags": json.dumps(["Web3", "Blockchain", "DApp", "Smart Contracts"])
        },
        {
            ...
            "rating_count": 567,
            "average_rating": 4.9,
            "tags": json.dumps(["Productivity", "Life Hacks", "Time Management", "Efficiency"])
        },
        {
            ...
            "rating_count": 389,
            "average_rating": 4.5,
            "tags": json.dumps(["Cryptocurrency", "Investment", "Finance", "Beginner Guide"])
        }
    ]
...
def main():
    ...
    print("🚀 Creating sample data for EmpowerVerse (SQLite)...")
    ...
    try:
        ...
        print(f"\n💾 Database file: empowerverse_demo.db")
        print(f"🚀 Your EmpowerVerse database is now ready for presentation!")
